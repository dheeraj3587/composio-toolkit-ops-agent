...
> & {
  /**
   * The reasoning text. Rendered as inert plain text — never markdown —
   * because it is model-authored prose read off a live third-party page.
   * Plain text means no links, images, or embedded HTML can come from it.
   */
  children: string;
};

/** The thinking itself: dimmed, inert text that unfolds under the trigger. */
export const ReasoningContent = ({
  ...
  <Collapsible.Panel
    ...
    {...props}
  >
    <p className="whitespace-pre-wrap pt-1 pb-0.5 text-muted-foreground text-sm leading-relaxed">
      {children}
    </p>
  </Collapsible.Panel>
);
