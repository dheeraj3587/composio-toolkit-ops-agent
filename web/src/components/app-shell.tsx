    ...
    <div className={`min-h-svh bg-background ${pagePadding}`}>
      ...
      >
        <div className="flex h-20 items-center border-b border-white/10 px-6">
          <Link href="/" className="group flex items-center gap-3" aria-label="Composio Operations home">
            <span className="grid size-9 place-items-center rounded-md border border-brand-dev bg-brand-dev font-mono text-[12px] font-semibold tracking-[0.16em] text-rail transition-colors group-hover:border-brand-400 group-hover:bg-brand-dev/80">
              C/O
            </span>
            <span>
              <span className="block text-sm font-semibold leading-none">Composio</span>
              <span className="mt-1 block font-mono text-[11px] uppercase tracking-[0.16em] text-white/45">
                Operations
              </span>
            </span>
          </Link>
        ...
        <nav className="flex-1 space-y-1 px-3 py-6" aria-label="Primary navigation">
          <p className="px-3 pb-2 font-mono text-[11px] font-medium uppercase tracking-[0.18em] text-white/35">
            Control plane
          </p>
          {navigation.map((item) => (
        ...
        <div className="m-3 rounded-xl border border-white/10 bg-white/[0.035] p-4">
          ...
          <div className="mt-4 flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.12em] text-emerald-300">
        ...
        <div className="flex items-center justify-between border-t border-white/10 px-5 py-3">
          ...
          <form action={signOutAction}>
            <button
              type="submit"
              className="inline-flex items-center gap-1.5 rounded-lg px-2 py-1.5 text-[12px] font-medium text-white/50 hover:bg-white/10 hover:text-white"
              title="Sign out"
            >
      ...
      >
        <Link href="/" className="flex items-center gap-2 text-sm font-semibold" aria-label="Composio Operations home">
          <span className="grid size-8 place-items-center rounded-md bg-rail font-mono text-[11px] tracking-[0.14em] text-white">C/O</span>
          Operations
        </Link>
      ...
      <div className="lg:pl-64">
        ...
        <footer className="border-t border-border px-4 py-5 sm:px-7 lg:px-9 xl:px-12">
          <div className="mx-auto flex max-w-[1240px] flex-col gap-2 font-mono text-[11px] uppercase tracking-[0.13em] text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
