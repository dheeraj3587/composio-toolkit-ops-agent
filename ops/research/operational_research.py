...
# than imported from ``ops.you.research`` — that module already imports FROM
...
class OfficialURLPolicy:
    ...
    * ``wildcard_domains`` — matched as SUBDOMAINS ONLY, identical to
      ``ops.browser.host_policy.host_matches_patterns`` (a ``*.parent`` pattern
...
class OperationalResearchEnricher:
    ...
    async def _enrich_rich(
        ...
        *,
        ...
        # ops.you.research imports FROM this module already.
