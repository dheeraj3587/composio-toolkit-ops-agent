...
if TYPE_CHECKING:
    ...
    from ops.credential_validator import CredentialValidationPolicy
...
class AppRecipeCatalog(_RecipeModel):
    ...
    apps: tuple[AppRecipe, ...] = Field(min_length=50, max_length=50)
...
def recipe_to_operational_research(
    ...
    from ops.models import OperationalResearch
    from ops.p1_adapter import P1LookupNotFound, lookup_p1_record, to_operational_research
